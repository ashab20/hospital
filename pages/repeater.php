                ...
                <form action="" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <div class="repeater">
                        <div data-repeater-list="outer-list">
                            <div class="row" data-repeater-item >
                                ...
                                <div class="col-1 d-flex">
                                    <button class="btn btn-danger btn-sm mx-1" data-repeater-delete type="button">
                                        <i class="mdi mdi-minus"></i>del
                                    </button>
                        ...
                        <button class="btn btn-info btn-sm" data-repeater-create type="button">
